# Travel Time Matrix {#sec-ttm}

**Script:** [`03_ttm_gridh3.R`](https://github.com/U-Shift/IMPT-data/blob/main/code/03_ttm_gridh3.R)  
...
params <- data.frame(
    ...
    Value = c(
        ...
        "WALK",
        "15 minutes, 20 minutes (2 scenarios of egress)",
...
![Car travel time for a random sample of 5000 ODs](images/maps/ttm.png)