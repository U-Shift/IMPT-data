...
grid_aggregated <- impt_read(paste(data_dir, "grid_aggregated.geojson", sep = "/"))
freguesias_aggregated <- impt_read(paste(data_dir, "freguesias_aggregated.geojson", sep = "/"))
municipios_aggregated <- impt_read(paste(data_dir, "municipios_aggregated.geojson", sep = "/"))
