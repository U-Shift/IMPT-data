...
# fare_structure_folder <- tempdir(check = TRUE)
# list.files(fare_structure_folder)
# fare_stucture_pass_file <- impt_read("geo/r5r/fares_pass.zip", write_to = fare_structure_folder)
# fare_pass <- r5r::read_fare_structure(fare_stucture_pass_file)

# fare_stucture_single_file <- impt_read("geo/r5r/fares_single.zip", write_to = fare_structure_folder)
