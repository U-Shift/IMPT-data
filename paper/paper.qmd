...
The matrix was computed using (<!--# é preciso especificar os parâmetros da função? -->)

<!--# acabar -->

#### Cumulative number of opportunities

The cumulative number of opportunities was calculated (<!--# ponho a função usada? -->) considering the travel time matrices for each grid cell combination, the number of opportunities per grid cell, and the travel time cut-offs.
...
knitr::kable(accessibility_n_opportunities, align = c("l", "c", "c", "c", "c", "c"))
```
...
Mobility evaluates the quality of the transportation system as a service, independently of the accessibility of the destinations. Its principal indicators are (...)
...
The indicators calculated for each geographical unit and transport mode are systematized in @tbl-safety_indicators.

<!--# fazer melhor esta tabela (como escrever em latex dentro da tabela...?) -->

```{r}
#| label: tbl-safety_indicators
#| tbl-cap: Travel time threshold (minutes) to compute cumulative number of opportunities
#| echo: true
safety_indicators <- data.frame(
  "Indicator" = c("Total accidents (5 years)",
                  "Fatalities (30-day)",
                  ...
                  "Severity index (walking)"
                  ),
  "Formula" = c("Count",
                "sum(VM_30d)",
                "sum(FG_30d)",
                "sum(FL_30d)",
                "total_accidents/population × 1000",
                "fatalities/population × 1000",
                "fatalities/total_victims",
                "fatalities/motorized_vehicles_involved",
                "fatalities/cycling_involved",
                "fatalities/pedestrians_involved"),
  check.names = FALSE
)
knitr::kable(safety_indicators)
```

## Normalisation and Aggregation {#sec-normalisation}
