...
<!--# é preciso justificar mais porquê usar a definição da Lucas? -->
...
- Critical IMPT: based on the geometric mean, it penalizes the dimension with the worst performance.
