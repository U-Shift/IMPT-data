...
: Indicators used in the IMPT {#tbl-all_indicators}
...
: Data sources used {#tbl-data_sources}
...
: GTFS sources for LMA public transport operators {#tbl-gtfs_sources}
...
: POI categories, sources and filters {#tbl-poi_categories}
...
: Parameters used in the computation of the travel time matrix {#tbl-ttm_parameters}
...
: Travel time threshold (minutes) to compute cumulative number of opportunities {#tbl-accessibility_n_opportunities}
...
: Public transport service frequency periods observed {#tbl-headway_periods}
