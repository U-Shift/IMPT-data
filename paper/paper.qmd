...
This project was thus developed in an attempt to bridge the existing methodological gap with the creation of a composite tool - the Multidimensional Transport Poverty Index (IMPT) - that is systematic, replicable and scalable, as well as wholly based in public data, intended to assist and support public policy instruments, such as the European Union's Social Climate Fund (SCF) or Sustainable Urban Mobility Plans (SUMPs). The Lisbon Metropolitan Area (LMA) was employed as a case study for the tool's validation.
