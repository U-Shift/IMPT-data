...
1.  **Critical IMPT - geometric mean** (equal weights, @fig-impt-geometric): $$IMPT_{geom} = \left(\prod_{d} (S_d + 1)\right)^{1/n} - 1$$
...
2.  **Balanced IMPT - arithmetic mean** (equal weights, @fig-impt-arithmetic): $$IMPT_{avg} = \frac{1}{n} \sum_d S_d$$
...
3.  **Contrasting IMPT - entropy-weighted geometric mean** (@fig-impt-entropy): $$IMPT_{entropy} = \prod_d (S_d + 1)^{w_d} - 1$$
...
::: {#fig-impt-methods layout="[[1,1,1]]"}
![Critical IMPT (geometric mean)](../documents/images/maps/impt_geometric.png){#fig-impt-geometric}

![Balanced IMPT (arithmetic mean)](../documents/images/maps/impt_arithmetic.png){#fig-impt-arithmetic}

![Contrasting IMPT (entropy-weighted mean)](../documents/images/maps/impt_entropy.png){#fig-impt-entropy}
...
![IMPT Dashboard](../documents/images/prints/dashboard.png)
:::
