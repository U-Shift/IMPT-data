...
\item
  Mobility - the systemic deficiencies of the transportation system
  itself that impact necessary trips, and which are expressed in
  parameters such as low service frequency or average commuting time.
\item
  Affordability - the ability of households to meet the cost of
  transportation.
\item
  Exposure to externalities (Safety) - the negative exposure to the
  transport system itself, such as environmental pollution or road crash
  rates.
\end{itemize}
