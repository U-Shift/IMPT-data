...
\texttt{tidytransit::get\_stop\_frequency()} for four different time
windows, as can be seen in
...
pedestrian ratio. However, cycling infrastructure is further classified
according to its level of segregation:
