...
Data should be stored in the `/data` directory, accessible to all users at `ushift@alfa` server. For this reason, the usage of https://server.ushift.pt/rstudio/ is recommended to work with this repository.
